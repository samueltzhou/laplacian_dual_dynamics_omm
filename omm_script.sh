NAME=effseq_diagpenalty_5_9_25
NUMBER=2
...
# nohup python train_laprepr.py gridmaze_7_${NAME}_run_${NUMBER} --config_file omm.yaml --use_wandb --env_name GridMaze-7
# nohup python train_laprepr.py gridmaze_9_${NAME}_run_${NUMBER} --config_file omm.yaml --use_wandb --env_name GridMaze-9
# nohup python train_laprepr.py gridmaze_17_${NAME}_run_${NUMBER} --config_file omm.yaml --use_wandb --env_name GridMaze-17
